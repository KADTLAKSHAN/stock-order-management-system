<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="DDFootwear.Login" %>
...
<head runat="server">
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(-45deg, #eecda3 0%, #ef629f 100%);
        }
        form {
...
<body>
    <form id="form1" runat="server" class="frmalg">
        ...
        <div class="container">
            <center>
                <h3>DD Footwear Stock Management System</h3>
            </center>
            <label for="uname"><b>Company User Email</b></label>
