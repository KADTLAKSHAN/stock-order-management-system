<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageSize.aspx.cs" Inherits="DDFootwear.ManageSize" %>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="ManageSize.aspx" class="active" ><span class="las la-upload"></span>
        ...
        <div class="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                        ...
                                        <asp:GridView ID="drvSizes" runat="server"></asp:GridView>
                    ...
                    <div class="pregistertitle">Search,Update and Delete</div>
                        <div class="puser-details">
                            <div class="pinput-box">
                                <span class="details">Size Number</span>
                                <asp:TextBox ID="txtSizenumUP" class="form-control" runat="server" ></asp:TextBox>
                            </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Size ID:</label>
                        <asp:TextBox ID="txtSizeID" class="form-control" runat="server" TextMode="Number" ></asp:TextBox>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Product Size:</label>
                        <asp:TextBox ID="txtSizeNo" class="form-control" runat="server" TextMode="Number" ></asp:TextBox>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnAdd" class="btn btn-primary" runat="server" Text="Add New Size" OnClick="btnAdd_Click"/> 
                </div>
                </div>
            </div>
            </div>
