<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageDiscount.aspx.cs" Inherits="DDFootwear.ManageDiscount" %>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="ManageDiscount.aspx" class="active"><span class="las la-upload"></span>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                        ...
                                        <asp:GridView ID="drvDiscount" runat="server"></asp:GridView>
                    ...
                    <div class="pregistertitle">Search,Update and Delete</div>
                        <div class="puser-details">
                            <div class="pinput-box">
                                ...
                                <asp:TextBox ID="txtDiscountUp" class="form-control" runat="server" ></asp:TextBox>
                            </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox ID="txtDisID" class="form-control" runat="server" ></asp:TextBox>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Discount Rate:</label>
                        <asp:TextBox ID="txtDisRate" class="form-control" runat="server" ></asp:TextBox>
                    </div>
